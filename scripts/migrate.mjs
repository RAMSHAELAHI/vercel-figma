...
const {
  NEXT_PUBLIC_SANITY_PROJECT_ID="2r79i5c8",// Sanity project ID
  NEXT_PUBLIC_SANITY_DATASET="production", // Sanity dataset (e.g., "production")
  NEXT_PUBLIC_SANITY_AUTH_TOKEN="skfKflLImFtPjnzzCQCjouJkvExDBWtRJPYDbkfzz16m8JC0ePsOD5cvCWMqbNIpRcLMTH8OOrQBUf07NVTXBTPDeIAYpaZuYXuk6FddpuuTWBIHNTBzJIwigmQpGJzrSUmkjfoyRMB4wgUhQHPWgLRjAluVNz8P97uYOF0pJa741IueSFGR",// API token for authentication
...
const targetClient = createClient({
  projectId: "2r79i5c8" , // Your Sanity project ID
  dataset: NEXT_PUBLIC_SANITY_DATASET || "production", // Default to "production" if not set
  useCdn: false, // Disable CDN for real-time updates
  apiVersion: "v2025-01-18", // Sanity API version
  token:  "skfKflLImFtPjnzzCQCjouJkvExDBWtRJPYDbkfzz16m8JC0ePsOD5cvCWMqbNIpRcLMTH8OOrQBUf07NVTXBTPDeIAYpaZuYXuk6FddpuuTWBIHNTBzJIwigmQpGJzrSUmkjfoyRMB4wgUhQHPWgLRjAluVNz8P97uYOF0pJa741IueSFGR"// API token for authentication
});
